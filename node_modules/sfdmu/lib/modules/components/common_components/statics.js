...
exports.CONSTANTS = {
    ...
    BINARY_FILE_CACHE_TEMPLATE: (id) => `${id}.blob`,
    BINARY_FILE_CACHE_RECORD_PLACEHOLDER: (id) => `[blob[${id}]]`,
    BINARY_FILE_CACHE_RECORD_PLACEHOLDER_ID: (value) => /\[blob\[([\w\d]+)\]\]/.exec(value || '')[1],
    BINARY_FILE_CACHE_RECORD_PLACEHOLDER_PREFIX: '[blob[',
    SOURCE_RECORDS_FILE_CACHE_TEMPLATE: (id) => `${id}.dat`,
    ...
    SPECIAL_MOCK_PATTERNS: new Map([
        [enumerations_1.SPECIAL_MOCK_PATTERN_TYPES.haveAnyValue, "*"],
        [enumerations_1.SPECIAL_MOCK_PATTERN_TYPES.missingValue, "^*"]
    ]),
    ...
    SUPPORTED_OBJECTS_FOR_OPERATION: new Map([
        ["FeedItem", new Array("Insert")],
        ["FeedComment", new Array("Insert")]
    ]),
    ...
    TEXTUAL_FIELD_TYPES: ['string', 'id',
        ...
        'phone',
        'multipicklist'],
    MANDATORY_QUERY_FIELDS_FOR_INSERT: new Map([
        ["Attachment", new Array("Body", "ParentId", "Name")],
        ["Note", new Array("Body", "ParentId", "Title")],
        ["ContentVersion", new Array("VersionData", "Title", "Description", "PathOnClient", "ContentUrl", "FirstPublishLocationId")]
    ]),
    MANDATORY_QUERY_FIELDS_FOR_UPDATE: new Map([
        ["Attachment", new Array("BodyLength", "Name")],
        ["ContentVersion", new Array("Title", "Description")]
    ]),
    EXCLUDED_QUERY_FIELDS: new Map([
        ["Attachment", new Array("Body")]
    ]),
    FIELDS_TO_UPDATE_ALWAYS: new Map([
        ["FeedComment", new Array("FeedItemId")]
    ]),
    __R_FIELD_MAPPING: new Map([
        ["FeedComment",
            {
    ...
    SIMPLE_REFERENCE_FIELDS: new Map([
        ["FeedComment", new Array("FeedItemId")]
    ]),
    REFERENCED_SOBJECT_TYPE_MAP: new Map([
        ["FeedComment",
            {
                "FeedItemId": "FeedItem"
            }
    ...
    REFERENCED_FIELDS_MAP: new Map([
        ["OwnerId", "User"],
    ]),
    FIELDS_TO_COMPARE_SOURCE_WITH_TARGET_RECORDS: new Map([
        ["Attachment", new Array("BodyLength", "Name")],
        ["ContentVersion", new Array("Title", "Description")]
    ]),
    FIELDS_EXCLUDED_FROM_TARGET_QUERY: new Map([
        ["Attachment", new Array("Body")],
        ["ContentVersion", new Array("VersionData")]
    ]),
    FELDS_NOT_TO_OUTPUT_TO_TARGET_CSV: new Map([
        ["Attachment", new Array("Body")],
        ["ContentVersion", new Array("VersionData")]
    ]),
